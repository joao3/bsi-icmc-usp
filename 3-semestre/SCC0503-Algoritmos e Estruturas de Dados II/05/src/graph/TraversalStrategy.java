...
public abstract class TraversalStrategy {
    ...
    public TraversalStrategy(AbstractGraph graph) {
        this.graph = graph;
    ...
    protected void printPath() {
        ...
        for (Vertex vertex : traversalPath) {
            visitedPath.append(vertex).append(' ').append("\n");
        }
    ...
    protected void printVisitTree() {
        ...
        treeStringBuilder.append(getGraph().getVertices().get(0).getData().stringToGraphviz()).append('\n');
        for (var i = 1; i < getGraph().getNumberOfVertices(); i++) {
            ...
            treeStringBuilder.append(getGraph().getVertices().get(i).getData().stringToGraphviz())
