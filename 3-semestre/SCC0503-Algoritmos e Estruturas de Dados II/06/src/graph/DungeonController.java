...
public class DungeonController {
    ...
    public static void main(String[] args) {
        ...
        TraversalStrategy bfs = new BreadthFirstTraversal(dungeonController.dungeon);
        bfs.traverseGraph(dungeonController.entrance);
        bfs.printPath();

        System.out.println("DFS");
        TraversalStrategy dfs = new DepthFirstTraversal(dungeonController.dungeon);
        dfs.traverseGraph(dungeonController.entrance);
        dfs.printPath();
